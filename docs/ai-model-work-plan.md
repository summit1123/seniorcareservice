...
3. 감지 결과를 통합 산식 우대 또는 예방 케어 판단으로 연결합니다.
...
```text
기존 마일리지·착한운전 특약이 거리와 일반 안전점수 중심이라면, 본 제안은 DBSCAN 생활권 중심과 P90 생활권 버퍼, 평소패턴 이상탐지를 결합해 익숙한 생활권 안의 안정 운전은 통합 산식 우대로, 버퍼 밖 위험 변화는 예방 케어로 분리합니다.
```
